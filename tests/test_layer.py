...
def test_encoder_layer():
    seq, e1_pos, e2_pos = tf.constant([[1, 2, 3, 4], [1, 2, 3, 4]]), tf.constant(
        [[0, 1, 2, 3], [0, 1, 2, 3]]), tf.constant([[4, 5, 6, 7], [4, 5, 6, 7]])
...
def test_entity_attention_layer():
    ...
    att = EntityAttentionLayer(3, 4, 5, 0.001)
...
def test_cnn_attention_layer():
    ...
    layer = CNNAttentionLayer(32, 3, 0.001)
